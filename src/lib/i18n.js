...
const translations = {
  en: {
    ...
    gifTool: {
      ...
      accuratePreviewLabel: 'Generate final GIF simultaneously',
      accuratePreviewHint: 'Encodes during preview for exact size and ready-to-download output (slower).',
      compressionSummaryTitle: 'Result summary',
      summaryOriginalSize: 'Original file',
      summaryCompressedSize: 'Estimated output',
  ...
  zh: {
    ...
    gifTool: {
      ...
      accuratePreviewLabel: '同时生成最终 GIF',
      accuratePreviewHint: '预览阶段直接编码获得真实体积，可立即下载（耗时更久）。',
      compressionSummaryTitle: '压缩结果概览',
      summaryOriginalSize: '原始文件',
      summaryCompressedSize: '预计输出',
