  ...
  en: {
    ...
    agentPrompt: {
      ...
      panelBrief: {
        ...
        imagePlaystore: 'Google Play icon generator for store-ready export.',
        imageAppstore: 'App Store icon generator for marketing icon export.',
    ...
    home: {
      ...
      pdfMergeDesc:
        'Combine multiple PDFs in your chosen order and download one merged file—useful for packets, appendices, and review bundles.',
      pdfSplitTitle: 'PDF Split',
      pdfSplitDesc:
        'Split selected pages into separate one-page PDFs and download them as a zip—handy for filing, review, and reuse.',
      pdfExtractTitle: 'PDF Page Extract',
      pdfExtractDesc:
        'Pick page ranges and download a smaller PDF with only those pages—useful for packets, reviews, and handoffs.',
    ...
    playstore: {
      title: 'Google Play Icon Generator',
    ...
    appstore: {
      title: 'App Store Icon Generator',
    ...
    pdfViewer: {
      title: 'PDF Preview',
      desc: 'Open PDFs locally with thumbnail navigation, page jump, and fit-to-view controls—nothing uploaded.',
      upload: 'Choose PDF',
      ...
      thumbnailHint: 'Click a thumbnail to jump directly.',
      zoomIn: 'Zoom in',
      zoomOut: 'Zoom out',
    ...
    pdfExtract: {
      title: 'PDF Page Extract',
      desc: 'Keep only selected pages and download a new PDF locally—good for review packets, excerpts, and handoffs.',
      uploadHint: 'Click or drag a .pdf file here',
      pageRange: 'Pages',
      pageRangePlaceholder: 'Example: 1,3-5,8',
      pageRangeHint: 'Use commas and ranges. Example: 1,3-5 keeps pages 1, 3, 4, 5.',
      ...
      needPages: 'Enter at least one page or range.',
      invalidRange: 'Invalid page range.',
      done: 'Done',
    },
    pdfPagePicker: {
      title: 'Pick pages visually',
      hint: 'Click pages to toggle them. Hold Shift to select a continuous range.',
      selectAll: 'All',
      selectOdd: 'Odd',
      selectEven: 'Even',
      clear: 'Clear',
      total: 'Total:',
      selected: 'Selected:',
      rendering: 'Rendering thumbnails...',
      selectedTag: 'Selected',
      advanced: 'Advanced page range',
      empty: 'Upload a PDF first, then select pages by clicking thumbnails.',
      previewError: 'Could not render page thumbnails.',
    },
    pdfMerge: {
      title: 'PDF Merge',
      desc: 'Combine multiple PDFs locally in your chosen order—good for packets, appendices, and review bundles.',
      uploadHint: 'Click or drag .pdf files here',
      orderHint: 'Files are merged from top to bottom. Drag cards to reorder before exporting.',
      empty: 'Upload at least one PDF to start building a merged file.',
      totalFiles: 'Files',
      totalPages: 'Total pages',
      outputPages: 'Output pages',
      outputSize: 'Output size',
      ...
      needFiles: 'Please upload at least one PDF.',
      moveUp: 'Move up',
      moveDown: 'Move down',
    ...
    pdfSplit: {
      title: 'PDF Split',
      desc: 'Split selected pages into separate one-page PDFs and download them as a zip—good for filing, review, and reuse.',
      uploadHint: 'Click or drag a .pdf file here',
      pageRange: 'Pages',
      pageRangePlaceholder: 'Example: 1,3-5,8',
      pageRangeHint: 'Leave empty to split every page, or enter selected pages and ranges.',
      totalPages: 'Total pages',
      splitPages: 'Pages to split',
    ...
    styleGuide: {
      ...
      pdfPickerTitle: 'PDF page picker',
      pdfThumbTitle: 'PDF thumbnail sidebar',
  ...
  zh: {
    ...
    agentPrompt: {
      ...
      panelBrief: {
        ...
        imagePlaystore: '「Google Play 图标生成」：导出符合 Play 要求的图标。',
        imageAppstore: '「App Store 图标生成」：导出符合 App Store 要求的图标。',
    ...
    home: {
      ...
      playstoreTitle: 'Google Play 图标生成',
      playstoreDesc: '一键导出 512×512 Play 商店图标，居中裁方，无需本地设计工具链。',
      appstoreTitle: 'App Store 图标生成',
      ...
      pdfMergeDesc: '按自定义顺序合并多个 PDF 并下载，适合资料包、附录与审阅合集。',
      pdfSplitTitle: 'PDF 拆分',
      pdfSplitDesc: '把选中的页面拆成独立单页 PDF，并打包成 zip 下载，适合归档、审阅和复用。',
      pdfExtractTitle: 'PDF 页面提取',
      pdfExtractDesc: '按页码范围提取并下载新的 PDF，适合审阅包、节选和交付。',
    ...
    pdfViewer: {
      title: 'PDF 预览',
      desc: '本地打开 PDF，支持缩略图导航、页码直达与适配视图，零上传，适合审阅与对照。',
      upload: '选择 PDF',
      ...
      fitWidth: '适配宽度',
      actualSize: '100%',
      thumbnailTitle: '页面缩略图',
      thumbnailHint: '点击缩略页可直接跳转。',
      zoomIn: '放大',
      zoomOut: '缩小',
      resetView: '重置视图',
      noFile: '上传 PDF 以开始预览。',
    ...
    pdfExtract: {
      title: 'PDF 页面提取',
      desc: '只保留选中的页面并本地下载新 PDF，适合审阅材料、节选与交付。',
      uploadHint: '点击或拖拽 .pdf 到此处',
      pageRange: '页码范围',
      pageRangePlaceholder: '例如：1,3-5,8',
      pageRangeHint: '支持逗号和区间。例如 1,3-5 表示保留第 1、3、4、5 页。',
      totalPages: '总页数',
      selectedPages: '选中页面',
      outputPages: '输出页数',
      outputSize: '输出大小',
      run: '提取页面',
      needFile: '请先上传 PDF。',
      needPages: '请至少输入一个页码或区间。',
      invalidRange: '页码范围无效。',
      done: '完成',
    },
    pdfPagePicker: {
      title: '可视化选页',
      hint: '点击页面即可选中或取消；按住 Shift 可连续选择一段页面。',
      selectAll: '全选',
      selectOdd: '奇数页',
      selectEven: '偶数页',
      clear: '清空',
      ...
      selectedTag: '已选',
      advanced: '高级页码输入',
      empty: '先上传 PDF，再通过缩略页直接点选要处理的页面。',
      previewError: '页面缩略图生成失败。',
    },
    pdfMerge: {
      title: 'PDF 合并',
      desc: '按你指定的顺序在本地合并多个 PDF，适合资料包、附录与审阅合集。',
      uploadHint: '点击或拖拽 .pdf 文件到此处',
      orderHint: '文件会按从上到下的顺序合并，直接拖拽卡片调整顺序后再导出。',
      empty: '请先上传至少一个 PDF，再开始合并。',
      totalFiles: '文件数',
      totalPages: '总页数',
      outputPages: '输出页数',
      outputSize: '输出大小',
    ...
    pdfSplit: {
      title: 'PDF 拆分',
      desc: '把选中的页面拆成独立单页 PDF，并打包成 zip 下载，适合归档、审阅和复用。',
      uploadHint: '点击或拖拽 .pdf 到此处',
      pageRange: '页码范围',
      pageRangePlaceholder: '例如：1,3-5,8',
      pageRangeHint: '留空表示拆分全部页面；也可输入指定页码和区间。',
      totalPages: '总页数',
      splitPages: '拆分页',
      outputFiles: '输出文件数',
      outputSize: 'zip 大小',
    ...
    styleGuide: {
      ...
      pdfPickerTitle: 'PDF 选页组件',
      pdfThumbTitle: 'PDF 缩略图侧栏',
      progressLabel: '加载示例',
    },
    imagePreview: {
      title: '图片预览',
